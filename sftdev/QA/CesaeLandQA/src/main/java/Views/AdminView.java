...
public class AdminView {
    ...
    public AdminView(String attractionsFilePath, String salesFilePath, String costsFilePath) throws FileNotFoundException {
        this.adminController = new AdminController(attractionsFilePath, salesFilePath, costsFilePath);
    }
