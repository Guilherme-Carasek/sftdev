...
public class EngView {
    ...
    public EngView (String attractionsFilePath, String salesFilePath) throws FileNotFoundException {
        this.engController = new EngController(attractionsFilePath, salesFilePath);
    }
